	...
	class FuturioWP_Demos {
      ...
      // Reset theme mods
        ...
        'elementor-blog-demo' => array(
					'categories'        => array( 'Blog', 'Elementor' ),
        ...
        'star-demo' => array(
					'categories'        => array( 'One Page', 'Elementor', 'Business' ),
        ...
        'ocean-demo' => array(
					'categories'        => array( 'Elementor', 'Business' ),
        ...
        'coffee-demo' => array(
					'categories'        => array( 'One Page', 'Elementor', 'Business', 'Landing Page' ),
        ...
        'app-landing-page' => array(
					'categories'        => array( 'One Page', 'Elementor', 'Landing Page' ),
      ...
      // Get recommended plugins
            ...
            <?php	if ( isset($recommended) && $recommended != '' )  { ?>
        ...
        <?php if ( !defined('FUTURIO_PRO_CURRENT_VERSION') && $premium['0']['slug'] == 'futurio-pro' ) { ?>
